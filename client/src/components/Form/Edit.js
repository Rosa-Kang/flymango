       ...
       <Paper className={classes.editPaper} id="editPaper">
           <Card className={classes.card}>
               ...
               <div className={classes.editOverlay2}>
                   <Button style={{ color: 'white' }} size="small" onClick={detailClose}>
               ...
               <Typography className={classes.editTitle} gutterBottom variant="h5" component="h2">
                   {post.title}
               </Typography>
               <CardContent>
           ...
           {!user?.result?.name ? (
               <Link to="/auth" style={{ textDecoration: 'none' }}>
                   <Button className={classes.edit} variant="contained" color="primary" size="small" maxWidth="xs">
                       Sign in to edit
                   </Button>
               </Link>
           ) : (
               <Button onClick={setEditPost} className={classes.edit} variant="contained" color="primary" size="small" maxWidth="xs">
                   Edit
               </Button>
           )}
       </Paper>
